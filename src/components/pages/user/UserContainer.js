  ...
  render() {
    return (
        <form>
            ...
            <CustomSelect type = { this.state.userForm.gender.type } elementConfig = { this.state.userForm.gender.elementConfig } value = { this.state.userForm.gender.value } valueChangeHandler = { this.valueChangeHandler } label = { this.state.userForm.gender.label } name = { this.state.userForm.name.name }  />
        </form>
    );
  }
